...
const chartCacheRepository = await import("../../src/charts/chart-cache-repository-smc.js");
...
describe("charts/chart-cache-repository-smc", () => {
  ...
  describe("loadLatestChartAnalysisCache", () => {
    test("trả candle_key mới nhất theo engine mode", async () => {
      ...
      const result = await chartCacheRepository.loadLatestChartAnalysisCache("smc");
