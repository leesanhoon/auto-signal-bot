...
// not filtered here.
const RAW_SEED_DATA: SeedSymbol[] = [
  ...
  { name: "KLAY/USDT", symbol: "BINANCE:KLAYUSDT", category: "crypto", active: false },
  { name: "GLMR/USDT", symbol: "BINANCE:GLMRUSDT", category: "crypto", active: false },
  { name: "MOVR/USDT", symbol: "BINANCE:MOVRUSDT", category: "crypto", active: true },
  { name: "MKR/USDT", symbol: "BINANCE:MKRUSDT", category: "crypto", active: false },
  ...
  { name: "PERP/USDT", symbol: "BINANCE:PERPUSDT", category: "crypto", active: false },
  ...
  { name: "OCEAN/USDT", symbol: "BINANCE:OCEANUSDT", category: "crypto", active: false },
  { name: "FLOKI/USDT", symbol: "BINANCE:FLOKIUSDT", category: "crypto", active: true },
  { name: "DENT/USDT", symbol: "BINANCE:DENTUSDT", category: "crypto", active: false },
  ...
  { name: "FXS/USDT", symbol: "BINANCE:FXSUSDT", category: "crypto", active: false },
  ...
  { name: "RDNT/USDT", symbol: "BINANCE:RDNTUSDT", category: "crypto", active: false },
  { name: "BEAM/USDT", symbol: "BINANCE:BEAMUSDT", category: "crypto", active: true },
  { name: "STRAX/USDT", symbol: "BINANCE:STRAXUSDT", category: "crypto", active: false },
  ...
  { name: "IDEX/USDT", symbol: "BINANCE:IDEXUSDT", category: "crypto", active: false },
  ...
  { name: "BAKE/USDT", symbol: "BINANCE:BAKEUSDT", category: "crypto", active: false },
  ...
  { name: "VOXEL/USDT", symbol: "BINANCE:VOXELUSDT", category: "crypto", active: false },
  { name: "C98/USDT", symbol: "BINANCE:C98USDT", category: "crypto", active: true },
  { name: "ALPACA/USDT", symbol: "BINANCE:ALPACAUSDT", category: "crypto", active: false },
  ...
  { name: "MBOX/USDT", symbol: "BINANCE:MBOXUSDT", category: "crypto", active: false },
  { name: "WING/USDT", symbol: "BINANCE:WINGUSDT", category: "crypto", active: true },
  { name: "LINA/USDT", symbol: "BINANCE:LINAUSDT", category: "crypto", active: false },
  ...
  { name: "BNX/USDT", symbol: "BINANCE:BNXUSDT", category: "crypto", active: false },
...
const SEED_DATA: SeedSymbol[] = RAW_SEED_DATA.map((entry) => ({
  ...entry,
  active: MAIN_ACTIVE_SYMBOLS.has(entry.symbol),
}));
